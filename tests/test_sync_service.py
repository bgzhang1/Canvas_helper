    ...
    redacted = service._redact_file_metadata(
        {
            ...
            "url": "https://canvas.example.edu/files/1/download?verifier=secret",
            "thumbnail_url": "https://canvas.example.edu/thumbnail?verifier=secret",
            "preview_url": "https://canvas.example.edu/preview?verifier=secret",
        }
    )
